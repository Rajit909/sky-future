    ...
    <>
      <footer className="w-full bg-gray-900">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          {/* <!--Grid--> */}
          <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-8 gap-6 pt-14 pb-20 max-w-md mx-auto md:max-w-xl lg:max-w-full">
            {/* <!--End Col--> */}
            ...
            <div className="block">
              <div className="p-2">
                <h3 className="text-blue-600 text-xl font-bold p-2">Contact</h3>
            ...
            <p className=" text-gray-300 pl-16">+91 9690579679</p> 
            ...
            <div className="block">
                <h2 className="p-2 text-blue-600">Find Here...</h2>
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d438.76692010884784!2d79.4054112331352!3d28.384979309023336!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39a00712e924d6d3%3A0x457a2c8fb4ea9055!2sGandhi%20Puram%2C%20Izatnagar%2C%20Bareilly%2C%20Uttar%20Pradesh%20243502!5e0!3m2!1sen!2sin!4v1715060665397!5m2!1sen!2sin"
                style={{ border: "0", marginBottom: "10px" }}
                allowFullScreen=""
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
                className="w-full lg:w-[900px] h-[300px] lg:h-[400px]"
              ></iframe>
            </div>
          </div>
          {/* <!--Grid--> */}
